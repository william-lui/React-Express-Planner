...
const mapDispatchToProps = (dispatch) => ({
  ...
  fetchDishes: (dishQuery) => {
    dispatch(fetchDishes(dishQuery));
  },
  resetFeedbackForm: () => {
...
class Main extends Component {
  componentDidMount() {
    ...
    //this.props.fetchDishes("chicken");
    ...
    return (
      <div>
        <Header
          ...
          quoteLoading={this.props.quote.isLoading}
          quoteErrMess={this.props.quote.errmess}
